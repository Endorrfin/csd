        ...
        <article class="vacancy-detail__body">
          ...
          @if (vacancy()!.region) {
            <p class="location">
              ...
              @if (vacancy()!.community) {
                · {{ vacancy()!.community }}
              }
              @if (vacancy()!.settlement) {
                · {{ vacancy()!.settlement }}
              }
            </p>
          }
          ...
          <section class="vacancy-detail__section">
            ...
            <div
              [innerHTML]="
                (lang === 'ua' ? vacancy()!.descriptionUa : vacancy()!.descriptionEn) | quillHtml
              "
            ></div>
          </section>
          ...
          @if (vacancy()!.requirementsUa || vacancy()!.requirementsEn) {
            <section class="vacancy-detail__section">
              ...
              <div
                [innerHTML]="
                  (lang === 'ua' ? vacancy()!.requirementsUa : vacancy()!.requirementsEn)
                    | quillHtml
                "
              ></div>
            </section>
...
export class VacancyDetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.api.get<VacancyDetail>(`vacancies/${id}`).subscribe({
      next: (data) => {
