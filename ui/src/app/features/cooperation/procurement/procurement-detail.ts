        ...
        @if (item()!.shortDescriptionUa || item()!.shortDescriptionEn) {
          <section class="pd__section">
            ...
            <div
              class="pd__rich-text"
              [innerHTML]="
                (isUa ? item()!.shortDescriptionUa : item()!.shortDescriptionEn) | quillHtml
              "
            ></div>
            ...
            @if (item()!.detailedDescriptionUa || item()!.detailedDescriptionEn) {
              <div
                class="pd__rich-text"
                [innerHTML]="
                  (isUa ? item()!.detailedDescriptionUa : item()!.detailedDescriptionEn) | quillHtml
                "
              ></div>
            }
          </section>
          ...
          <div class="pd__grid">
            ...
            @if (item()!.bidSubmissionDeadline) {
              <div class="pd__field">
                ...
                <span class="pd__deadline"
                  >📅 {{ item()!.bidSubmissionDeadline | slice: 0 : 10 }}</span
                >
              </div>
            }
